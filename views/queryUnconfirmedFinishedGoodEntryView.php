...
<fieldset class="ui-grid-a">
    <div class="ui-block-a"><a href="<?php echo base_url('finishedgoodentry/queryUnconfirmedFinishedGoodEntryView');?>" data-role="button" data-icon="flat-bubble" data-theme="f">成品入庫</a></div>
</fieldset>
<hr size="5" noshade>
